<template>
  <div class="person">
    ...
    <i-form style="padding-left:20px;margin-top:30px">
      <Form-item label="昵称">
        <i-input placeholder="请输入" v-model="userInfo.nickName"></i-input>
      </Form-item>
      <Form-item label="博客名">
        <i-input placeholder="请输入" v-model="userInfo.blockName"></i-input>
      </Form-item>
      <Form-item label="座右铭">
        <i-input placeholder="请输入" v-model="userInfo.motto"></i-input>
      </Form-item>
      <Form-item label="头像">
        <br />
        <img
